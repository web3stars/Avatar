    ...
    IERC404
{
    ...
    /// @dev Initial chain id for EIP-2612 supportclear
    ...
    function upgradeInitialize() public onlyOwner {
    ...
    function getERC721TokensInQueue(
        ...
        for (uint256 i = start_; i < start_ + count_; ) {
            uint256 id;
            (id, , ) = vault.peek(i);
            tokensInQueue[i - start_] = ID_ENCODING_PREFIX + id;
    ...
    function erc721TransferFrom(
        ...
        _transferERC20(from_, to_, _getUnit());
    ...
    function _transferERC20WithERC721(
        ...
        if (isFromERC721TransferExempt && isToERC721TransferExempt) {
            ...
            uint256 tokensToRetrieveOrMint = (balanceOf[to_] / _getUnit()) -
                (erc20BalanceOfReceiverBefore / _getUnit());
            ...
            uint256 tokensToWithdrawAndStore = (erc20BalanceOfSenderBefore /
                _getUnit()) - (balanceOf[from_] / _getUnit());
            ...
            uint256 nftsToTransfer = value_ / _getUnit();
    ...
    function _withdrawAndStoreERC721(address from_) internal virtual {
        ...
        vault.enqueue(uint16(id), from_, block.timestamp);
    }
    ...
    function _reinstateERC721Balance(address target_) private {
        uint256 expectedERC721Balance = erc20BalanceOf(target_) / _getUnit();
